...
function placeOrder(){let p=document.getElementById("player").value.trim();if(!p)return alert("Enter your Free Fire Player ID");let n=document.getElementById("name").value.trim();alert("Order created!\n\nEasypaisa Payment\nMerchant Number: 03276303979\n\nPlease complete your payment and keep your order details.");}
